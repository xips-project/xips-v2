pipeline {
    ...
    stages {
        ...
        stage('PIT Mutation') {
                    steps {
                        sh '/var/jenkins_home/tools/hudson.tasks.Maven_MavenInstallation/maven/bin/mvn verify -DwithHistory test-compile org.pitest:pitest-maven:mutationCoverage'
